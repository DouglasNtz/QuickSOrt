use QuickSort::{quick_sort, stable_quick_sort, randomized_quick_sort, quick_sort_natural_stable, quick_sort_natural_stable_fast, randomized_quick_sort_natural_stable};
...
"###, times.iter().sum::<Duration>());
    ...
    println!(r###"Function: Randomized_Quick_Sort_natural_stable
Número de experimentos: {numero_experimentos}
Tamanho da lista de números: {tamanho_lista}
Tempo total: {:?}
"###, times.iter().sum::<Duration>());
